...
export function StatCards({ totalRdvs, prochainRdv, derniersRdvs }: StatCardsProps) {
  return (
    <div className="grid grid-cols-2 gap-4">
      ...
      {/* Consultations */}
      <Link href="/dashboard/patient/rdvs" className="group bg-white rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow">
      ...
      <Link href="/dashboard/patient/rdvs" className="group bg-white rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow">
        ...
        {prochainRdv ? (
          ...
          <>
            ...
            <p className="text-sm font-semibold text-[#007DFF]">Trouver un médecin</p>
          </>
        )}
      </Link>
