export function SearchIcon({ className = 'h-4 w-4 shrink-0 text-zinc-400' }: { className?: string }) {
  return (
...
export function LocationIcon({ className = 'h-4 w-4 shrink-0 text-zinc-400' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
